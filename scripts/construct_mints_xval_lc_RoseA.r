...
## Load data
# load("scratch/mints_construct_pop_data.rda",verbose=TRUE)
load("temp/urcAA_construct_pop_data.rda",verbose=TRUE)
str(urc.data)
...
conStruct(spatial = TRUE,K = 2,freqs = urc.data$allele.frequencies,
          ...
          prefix = "output/constructAA/K2_sp.1",n.iter = 10000, 
