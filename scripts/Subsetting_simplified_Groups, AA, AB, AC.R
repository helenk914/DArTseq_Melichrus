...
for (subsets in c("AA","AB","AC","BB","BA","CB","CA","CC")){
  Subsetgl <- mygl[match(metadata$id[which(metadata$Secondary_PCA_groups==subsets)],mygl$ind.names),]
...
#Define palette
mypalette <- c("#0ff1ce","#696969","#bada55","#ff0000","#ffd700","#407294","#cbcba9","#065535","#5ac18e","#f7347a","#576675","#ffe4e1","#008080","#ffa500","#8a2be2","#800080","#F5F57A","#F37B7A","#E69F00","#7fe5f0")
